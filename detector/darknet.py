...
# 코랩으로 돌리기 위해 os, sys 임포트
import os
import sys
# 경로 설정
sys.path.append('/content/drive/MyDrive/24summerproj.codeit')
# util.py작성 후
from util import *
import torch
...
# test
model = Darknet('/content/drive/MyDrive/24summerproj.codeit/yolov3.cfg')
model.load_weights("/content/drive/MyDrive/24summerproj.codeit/yolov3.weights")
