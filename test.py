# 운전자 졸음 운전 및 폭행 모니터링 시스템
# 이 프로그램은 운전자의 졸음 상태, 스마트폰 사용, 그리고 운전자를 향한 탑승자의 위협적인 행동을 감지합니다.
...
def detect_hand_movement(frame):
    global driver_face, last_alarm_time, alarm_interval, current_hand_speed, attack_warning_count
